  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'bg-brand-surface border border-brand-walnut/40 rounded-xl shadow-2xl',
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded p-1 text-brand-muted hover:text-brand-white transition-colors focus:outline-none focus:ring-1 focus:ring-brand-gold/50">
        <X size={16} />
